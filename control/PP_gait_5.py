...
def act(t, para):
	...
	# back positive
	b_pos = para[2] * np.sin(t * para[4]) + para[3]
	# back negative
	b_neg = -para[2] * np.sin(t * para[4]) + para[3]
	desired_p = np.array([0, f_pos, f_pos, 0, f_neg, f_neg, 0, b_neg, b_neg, 0, b_pos, b_pos])
	return desired_p
...
if __name__ == '__main__':
	from body.PinkPanther.PinkPantherEnv_5 import PinkPantherEnv
