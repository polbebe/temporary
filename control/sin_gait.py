...
def sin_move(ti, para):
    ...
    # print(ti)
    s_action[0] = para[0] * np.sin(ti * 0.21 + para[2]) + para[10]  #LF # left   hind
    s_action[3] = para[1] * np.sin(ti * 0.21 + para[3]) + para[11]  #RF # left   front
    s_action[6] = para[1] * np.sin(ti * 0.21 + para[4]) - para[11]  #LB # right  front
    s_action[9] = para[0] * np.sin(ti * 0.21 + para[5]) - para[10]  #RB # right  hind

    s_action[1] = para[6] * np.sin(ti * 0.21 + para[2]) - para[12]  #LF # left   hind
    s_action[4] = para[7] * np.sin(ti * 0.21 + para[3]) - para[13]  #RF # left   front
    s_action[7] = para[7] * np.sin(ti * 0.21 + para[4]) - para[13]  #LB # right  front
    s_action[10]= para[6] * np.sin(ti * 0.21 + para[5]) - para[12]  #RB # right  hind

    s_action[2] = para[8] * np.sin(ti * 0.21 + para[2]) + para[14]  #LF # left   hind
    s_action[5] = para[9] * np.sin(ti * 0.21 + para[3]) + para[15]  #RF # left   front
    s_action[8] = para[9] * np.sin(ti * 0.21 + para[4]) + para[15]  #LB # right  front
    s_action[11]= para[8] * np.sin(ti * 0.21 + para[5]) + para[14]  #RB # right  hind
...
if __name__ == '__main__':
    from body.PinkPanther.PinkPantherEnv_Read_15params import PinkPantherEnv
